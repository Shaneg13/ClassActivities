...
// these two functions are not good practice....
...
// try to print the variable "total" outside the function
// ? what do you expect ?
// console.log(total); // We expect that an error will be thrown because total is initialized in a child scope and therefor not accessible from the global scope
...
//   childScope(parentVariable);
//   console.log("Parent Scope, Parent Variable:", parentVariable);
//   console.log("Parent Scope, Child Variable:", childVariable); // This console log will not print because childVariable is not accessible from the scope of this function because it is initialized in the scope of the "childScope" function
// }
